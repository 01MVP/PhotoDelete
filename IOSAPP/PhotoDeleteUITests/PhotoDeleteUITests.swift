...
final class PhotoDeleteUITests: XCTestCase {
    ...
    func testOnboardingFlowCompletesToHome() throws {
        ...
        XCTAssertTrue(
            app.staticTexts["OnePhoto"].waitForExistence(timeout: 10) ||
    ...
    func testHomeShowsActionableLibraryState() throws {
        ...
        XCTAssertTrue(app.staticTexts["OnePhoto"].waitForExistence(timeout: 10))
        XCTAssertTrue(
    ...
    func testSettingsTabShowsCoreControls() throws {
        ...
        XCTAssertTrue(app.staticTexts["给 OnePhoto 评分"].exists)
