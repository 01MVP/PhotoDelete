...
struct SettingsView: View {
        ...
        VStack(spacing: 16) {
            ...
            VStack(spacing: 0) {
                SettingRow(
                    icon: "star",
                    iconColor: PhotoDeleteStyle.warning,
                    title: L10n.string("给 OnePhoto 评分"),
                    showsChevron: false,
    ...
    private func openFeedbackMailURL() {
        ...
        components.queryItems = [
            URLQueryItem(name: "subject", value: L10n.string("OnePhoto App 反馈")),
                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: 20) {
                        VStack(alignment: .leading, spacing: 8) {
                            ...
                            Text(L10n.string("默认跟随 iPhone 系统语言。也可以在这里固定 OnePhoto 的显示语言。"))
...
struct MailComposeView: UIViewControllerRepresentable {
    ...
    func makeUIViewController(context: Context) -> MFMailComposeViewController {
        ...
        composer.setSubject(L10n.string("OnePhoto App 反馈"))
                    ...
                    VStack(alignment: .leading, spacing: 18) {
                        ...
                        VStack(spacing: 12) {
                            ...
                            PrivacyInfoRow(
                                ...
                                detail: L10n.string("OnePhoto 不接入自己的云端服务，也不会把照片发到服务器。")
                            )
